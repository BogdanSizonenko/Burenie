"""
Django settings for bur_form project.
...
SECRET_KEY = 'django-insecure-p=(ifc4tzch*#p17w*9h#^4kb6272+)@$7wy^&k%dbwbxd0f2('
...
WSGI_APPLICATION = 'bur_form.wsgi.application'
